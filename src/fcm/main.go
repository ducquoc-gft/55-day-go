...
const FCM_SERVER_KEY = "AAAAWZeZA2Q:APA91bF87EjWJxE5v6wJHrwS_5XayelaLP_pjJJ0_s6w_QHYSuEe18OBbKLsJD-n0dXpEiRpNHYQ9mTZsDbeqf6yFO3Rso9rVqUgG2vJnPUj3hj1-y_ScS8ANP_pJQeNwIK0T7X6bo8o"
const FCM_REG_TOKEN = "dXWz4A3SQpGV4n9VJbz5zN:APA91bEHcpsIay8mRMjTF4mHXFATRElq5DDb-L1oy4WDb86cuGkcFocTRWU0BFCL8wauu5u-KZHiJHh5g2x8cbDtr7K6gicCFz7U6MmRBVMtlQ3zz1XT8DS509j6P4oKMjnoffDSTLX8"
const FCM_API_KEY = "AIzaSyBUyXtDLB657j7bAKdEPFtO0nEm7xqiXLE"
const FCM_OAUTH2_TOKEN = "AAAAWZeZA2Q:APA91bH-4mUl6iIk8-I7pgWZaEjwchSNkFkRYe3yn5JYkmnxkioJr7VTcqdqXr0JpKma2n8X66IPrDMcXlFsUzSk-C3HKGZW9A9SztbM2onhSDBF6mw_IOeMSDDySKorm5emeC-bVMpY"
...
func internalPushNotification(msg *fcm.Message) {
	...
	client, err := fcm.NewClient(FCM_SERVER_KEY)
	if err != nil {
